...
namespace Scrut
{
    ...
    private:
        ...
        /// <summary>
        /// Appends the header info that is sent on each call to the 
        /// RequestHeader member variable. 
        /// </summary>
        void InitHeaders();
        ...
        /// </summary>
        std::mutex RecvDataMutex;

        /// <summary>
        /// Conditional variable to be used when we want to 
        /// receive data from the server
        /// </summary>
        std::condition_variable RecieveDataCondition;
